...
<body id="page-top" class="index">
    ...
    <header class="intro-header" style="background-image:url('img/halloween.jpg'); background-position-x:50%; background-position-y:30%; background-size:cover; min-height:550px;">
        <div class="container">
            <div class="row">
