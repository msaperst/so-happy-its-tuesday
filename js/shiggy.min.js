...
$.ajax({type:"POST",url:"php/update-hasher.php",data:{data:hasher}}).done(function(){});$('#hasherModal').modal('hide');});$('.hashname').click(function(){$.get("php/get-hare-count.php",{id:$(this).closest('tr').attr('hasher-id')}).done(function(data){console.log(data);});});});